...
//  SelectGameModeView
//
//  Created by David Grossman on 6/13/20.
...
public struct Colors {
    ...
    public static let LightGreen:Color = Color(hexString: "#C2FFCF")
    public static let FlagBlue: Color = Color(hexString: "#0038B8")
...
// make a style for a custom text field -- used in search bar
public struct CustomTextFieldStyle : TextFieldStyle {
    public func _body(configuration: TextField<Self._Label>) -> some View {
        configuration
            .font(.title) // set the inner Text Field Font
            .padding(2) // Set the inner Text Field Padding
            //Give it some style
//            .background(
